...
public class ToHtml {
    ...
    private static final String path = "C:/Users/user.symate/Documents/Tests/ApachePOI/";
    ...
    public void printPage() throws IOException {
        try {
            ...
            if (completeHTML) {
                ...
                out.format("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"\n" +
                        "        \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">%n");
                out.format("<html xmlns=\"http://www.w3.org/1999/xhtml\">%n");
                out.format("<head>%n");
    ...
    public void printStyles() {
        ...
        try {
            ...
            FileInputStream f = new FileInputStream(path + File.separator + "resources" + File.separator + "html" + File.separator + "excelStyle.css");
    ...
    private String replaceUmlaut(String input) {
        ...
        String o_strResult = input.replaceAll("ü", "&uuml;");
        o_strResult = o_strResult.replaceAll("ö", "&ouml;");
        o_strResult = o_strResult.replaceAll("ä", "&auml;");
        o_strResult = o_strResult.replaceAll("ß", "&szlig;");
